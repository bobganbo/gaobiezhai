...
<title><?php if(defined('SEO_TITLE') && SEO_TITLE != ''){ echo SEO_TITLE;}else{echo SITE_NAME;}?></title>
                ...
                <?php if(!empty($a['list'])){ foreach($a['list'] as $k => $v){?>
                    <li>
                        <dl>
                            ...
                            <dd class="play-type"><?php echo $v['cate']['cname']."（".LibUtil::STSH($v['end_time'])."）"; ?></dd>
                        ...
                        <li>
                            <p class="open" <?php if($k!=0) echo "style='display:none;'" ?> >
                                ...
                                <span class="r info-and-download">
                                    ...
                                    <a href="<?php echo $v['surl']?>" class="dwd">申请加入</a>
                                </span>
                            </p>
                            <p class="close" <?php if($k==0) echo "style='display:none;'" ?>>
                                ...
                                <span class="col-94 download-num"><?php echo LibUtil::STSH($v['end_time']);?></span>
                            </p>
                        </li>
                    <?php } } ?>
                    </ul>
