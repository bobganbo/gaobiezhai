 ...
 * 系统参数
 */
define("VERSION", "2.0.000"); // 版本号
define("AUTH_CODE", "AWLfDayQFZzXL1BrD43QBTf4H5OjBuNJAtxP57n9V5MZMTxIZ"); // 授权码
...
define("UPLOAD_CODE", "_36thn"); //上传安全码，该值安装时候自动生成，6-12位随机字母（大小写）数字，特殊符号
define("UPLOAD_KEY", "LM7jVv"); //上传密钥，该值安装时候自动生成，6-12位随机字母（大小写）数字，特殊符号
define("COMMENT_CODE", ""); //评论代码
define("APP_IMG_LOCAL", "0"); //添加应用是否图片本地化
define("CONTENT_NLINK", "0"); //是否开启正文内链
define("COUNT_CODE", ""); //统计代码
define("SEO_TITLE", "告别宅"); //首页SEO标题
define("SEO_KEYWORDS", "认识新朋友、告别懒虫生活"); //首页关键词
define("SEO_DESCRIPTION", "这是一个认识附近新朋友的网站"); //首页描述
